...
<%
	...
	Member gpm = aptService.selectGroupPresiService(m.getApt_APTGNo());
	...
	if(!candilist.isEmpty()){
		aptService.updateVflagService(2,"tndusdla92"); 
	}
...
<script type="text/javascript">
	function fn_insertForm() {
		$('.insertForm').prepend('<div class="col-md-2"></div><div class="col-md-8" style="padding-top:20px;"><form action="voteInsertCandi.jsp" method="post" enctype="multipart/form-data"><table border="1px"><tr><td>입주민 선택</td><td>'+
				...
				'<input type="submit" value="추가" style="margin-left:550px;"><input type="hidden" name="group" value="입주자대표"></form></div><div class="col-md-2"></div>');
	}
	...
	function fn_voteStart(){
		location.href="voteGroupPresi.jsp?changeVflag=3";
...
<c:if test="${!clist.isEmpty() }">
	...
	<c:forEach var="cn" items="${clist }">
		<div class="col-md-6">
		<form action="GroupPresiDelete.jsp?candi_no=${cn.candidateNo }" method="post">
...
<img src="../images/jeong/candidate_plus.png" onclick="fn_insertForm()" style="margin-left:30px"></div>
<div class="col-md-5"></div>
