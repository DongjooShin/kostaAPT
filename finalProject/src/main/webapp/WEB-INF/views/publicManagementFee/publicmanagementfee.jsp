			...
			<div class="row">
				...
				<div class="col-lg-8">
					...
					<div class="wrapper">
						...
						<div class="row">
							<div class="col-lg-6">
								...
								<div class="box box-primary">
									<div class="box-header with-border">
										<h3 class="box-title">전국평균 관리비 비교</h3>
							...
							<div class="col-lg-6">
								...
								<div class="box box-primary">
									<div class="box-header with-border">
										<h3 class="box-title">시/도별 관리비비교</h3>
										<div class="box-tools pull-right"></div>
									</div>
									<div class="box-body chart-responsive">
						...
						<div class="col-lg-12">
							<div class="box box-primary">
								<div class="box-header with-border">
									<h3 class="box-title">달별 공동관리비</h3>
					...
					<div class="row">
						<div class="col-lg-12 ">
							<h2>관리비 내역</h2>
							<button name="excel2" value="엑셀파일로" id="excel2">엑셀파일로 보기</button>
