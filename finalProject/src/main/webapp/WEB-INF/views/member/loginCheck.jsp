...
function check(){
	...
	if (num == 1) {
		if(!document.form.aptname.value){
			alert("아파트 찾기를 먼저 진행 해야합니다.");
			return false;
		}
		else{
...
<body>
	...
	<div id="page" class="hfeed site" style="height: 800px; border-top: 2px solid;">
		<div class="col-md-12">
			...
			<div class="col-lg-8" style="width: 70%; margin-top: 40px;">

				<div class="main">
					<form action="signup" name="form" method="get" onsubmit="return check()">
						<table width="1300" height="550">
							<tr>
								<td width="100%" height="50%" align="center">
									<p align="left">
										<span style="padding-left: 320px; font-size: 40px;">
											약관동의</span>
...
- 생성정보 수집 툴을 통한 수집
							...
							<tr>
								...
								<input type="hidden" value=""name="aptname"> 
								<input type="button" value="우리아파트 찾기" onclick="chk()" style="margin-left: 150px" />&nbsp;&nbsp;&nbsp;
