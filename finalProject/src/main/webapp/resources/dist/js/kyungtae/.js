/* Start of AIScript.js
   Version 2.2 by ActiveIntra Co., Ltd.
*/
...
*/
    ...
    var tagAIGeneratorOcx = 
        ...
        "  codebase='http://apt.thebill.co.kr/ebpp/thebill/ActiveX/AIViewer/AIGeneratorOcx.cab#Version=1,1,0,11'>\n" +
        //"   <param name='resource_base' value='http://myserver/AIViewer_path/'>\n" +
        //"   <param name='msg_color' value='(255,255,255)/(0,0,0)'>\n" +                   // 색상 => 배경색/폰트색 
        "</object>";
    
    var tagAIViewer =
        "<table align='center' width='100%' height='100%' border='0' bgcolor='#FFFFFF'>\n" +
        "<tr>\n" +
        "  <td>\n" +
    ...
    */ 
    ...
    /*
      AIViewer Control을 HTML에 embed하는 함수로 내부적으로 사용됨
    */
    function run() {
